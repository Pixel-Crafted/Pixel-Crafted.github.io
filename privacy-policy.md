...
This Privacy Notice for Pixel Crafted LLC ("**we**," "**us**," or "**our**"), describes how and why we might access, collect, store, use, and/or share ("**process**") your personal information when you use our services ("**Services**"), including when you:

*   Download and use our mobile application (Crave Crafted), or any other application of ours that links to this Privacy Notice
